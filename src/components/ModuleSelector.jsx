...
// ─── Registry de Módulos ──────────────────────────────────────────────────────
// Para agregar un nuevo módulo, solo añade un objeto aquí.
export const MODULES = [
    ...
    },
    {
        ...
        borderColor: '#6366f1',
        available: false, // Cambiar a true cuando el módulo esté listo
    },
    // Ejemplo de cómo agregar más módulos en el futuro:
    // {
    //   id: 'proyectos',
    //   label: 'Proyectos',
    //   description: 'Fondos y convocatorias de investigación.',
    //   icon: FlaskConical,
    //   color: '#10b981',
